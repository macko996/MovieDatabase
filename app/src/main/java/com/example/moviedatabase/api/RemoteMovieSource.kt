 ...
 */
@Singleton
class RemoteMovieSource @Inject constructor(private val movieService: MovieService) {

    /**
     * Gets popular movies
     */
    fun getPopularMovies(): LiveData<ArrayList<MovieNetworkEntity>>{

        val moviesLiveData : MutableLiveData<ArrayList<MovieNetworkEntity>> = MutableLiveData()
        ...
        movieCall.enqueue(object : Callback<ResultsResponse> {
            ...
            override fun onResponse(call: Call<ResultsResponse>, response: Response<ResultsResponse>){
                ...
                val movies = resultsResponse?.movies as ArrayList
         ...
         */
        fun getMovieRecommendations(movieId: Int): LiveData<ArrayList<MovieNetworkEntity>> {
            ...
            movieRecommendationsCall.enqueue(object : Callback<ResultsResponse> {
                ...
                override fun onResponse(call: Call<ResultsResponse>, response: Response<ResultsResponse>){
                    ...
                    val resultsResponse : ResultsResponse? = response.body()
                    val movieList = (resultsResponse?.movies ?: mutableListOf()) as ArrayList<MovieNetworkEntity>
         ...
         */
        fun searchMovie(query: String): LiveData<ArrayList<MovieNetworkEntity>> {
            val moviesLiveData : MutableLiveData<ArrayList<MovieNetworkEntity>> = MutableLiveData()
            ...
            movieSearchCall.enqueue(object : Callback<ResultsResponse> {
                ...
                override fun onResponse(call: Call<ResultsResponse>, response: Response<ResultsResponse>){
                    ...
                    val movies = response.body()?.movies as ArrayList
                    moviesLiveData.value = movies
                }
            })
         ...
         */
        fun getPersonMovieCredits(personId: Int) : LiveData<ArrayList<MovieNetworkEntity>> {
            ...
            personCreditsCall.enqueue(object : Callback<RootCreditsResponse> {
                ...
                override fun onResponse(call: Call<RootCreditsResponse>, response: Response<RootCreditsResponse>){
                    Log.d(TAG,"Received search ${response.body()}")
                    val movies = response.body()?.cast as ArrayList
                    moviesLiveData.value = movies
                }
            })
